...
docker run -d -e ICEES_DBUSER=$ICEES_DBUSER -e ICEES_DBPASS=$ICEES_DBPASS -e ICEES_HOST=$ICEES_HOST -e ICEES_PORT=$ICEES_PORT -e ICEES_DATABASE=$ICEES_DATABASE -e ICEES_API_LOG_PATH=/log/icees --name icees-api_server -v $ICEES_API_LOG_PATH:/log --net host icees-api:0.1.0
