...
template = {
  "info": {
    "title": "ICEES API",
      "description": "ICEES API [documentation](https://github.com/NCATS-Tangerine/icees-api/tree/master/docs) [source](https://github.com/NCATS-Tangerine/icees-api/tree/master/) [ICEES API example queries](https://github.com/NCATS-Tangerine/icees-api/tree/master/) <br>dictionary for versioning of tables<br><table><tr><th>version</th><th>table content</th></tr><tr><td>1.0.0</td><td>cdw, acs, nearest road, and cmaq from 2010</td></tr></table>",
    "version": "0.0.1"
  },
  "consumes": [
    "application/json"
